...
type ProbeResult struct {
	...
	T1 *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=t1,proto3" json:"t1,omitempty"` // Probe post time
	T2 *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=t2,proto3" json:"t2,omitempty"` // Prober CQE time
	T3 *timestamppb.Timestamp `protobuf:"bytes,5,opt,name=t3,proto3" json:"t3,omitempty"` // Responder receive time
	T4 *timestamppb.Timestamp `protobuf:"bytes,6,opt,name=t4,proto3" json:"t4,omitempty"` // Responder ACK post time
	T5 *timestamppb.Timestamp `protobuf:"bytes,7,opt,name=t5,proto3" json:"t5,omitempty"` // Prober ACK receive time
	T6 *timestamppb.Timestamp `protobuf:"bytes,8,opt,name=t6,proto3" json:"t6,omitempty"` // Prober poll complete time
...
func (x *ProbeResult) GetT1() *timestamppb.Timestamp {
	if x != nil {
		return x.T1
	}
	return nil
...
func (x *ProbeResult) GetT2() *timestamppb.Timestamp {
	if x != nil {
		return x.T2
	}
	return nil
...
func (x *ProbeResult) GetT3() *timestamppb.Timestamp {
	if x != nil {
		return x.T3
	}
	return nil
...
func (x *ProbeResult) GetT4() *timestamppb.Timestamp {
	if x != nil {
		return x.T4
	}
	return nil
...
func (x *ProbeResult) GetT5() *timestamppb.Timestamp {
	if x != nil {
		return x.T5
	}
	return nil
...
func (x *ProbeResult) GetT6() *timestamppb.Timestamp {
	if x != nil {
		return x.T6
	}
	return nil
...
func (x *PathInfo) GetTimestamp() *timestamppb.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
const file_proto_agent_analyzer_agent_analyzer_proto_rawDesc = "" +
	"\n" +
	")proto/agent_analyzer/agent_analyzer.proto\x12\x0eagent_analyzer\x1a\x1fgoogle/protobuf/timestamp.proto\"\x87\x01\n" +
	...
	"\x06tor_id\x18\x05 \x01(\tR\x05torId\"\x93\x01\n" +
	...
	"\n" +
	"flow_label\x18\x05 \x01(\rR\tflowLabel\"\xdc\x05\n" +
	"\vProbeResult\x12?\n" +
