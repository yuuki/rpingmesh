...
env RDMA_E2E_ENABLED=1 \
    go test -v -timeout 120s -run "^(TestRDMAE2E|TestProbeToOTelMetrics|TestProbeToPathAggregator|TestMultiRNICBothDevicesProbe|TestECMPMultiFlowLabel|TestInvalidGidIndexFailsFast)" ./e2e/
EXIT_CODE=$?
set -e
